...
/**
 * 文件编码检测工具, 核心代码来自cpdetector和jchardet, 可以检测大多数文件的编码
 * https://github.com/r91987/cpdetector, http://jchardet.sourceforge.net/
 * Created by wangfan on 2020-09-15 09:24
 */
public class JChardetFacadeUtil {
     ...
     *
     */
    public static interface nsICharsetDetectionObserver {
     ...
     *
     */
    public static interface nsICharsetDetector {
    ...
    public static class nsEUCSampler {
        ...
        float GetScore(float[] var1, float[] var2) {
            ...
            return (float) Math.sqrt((double) var4) / 94.0F;
        }
    }
